...
R Shiny allows users to create interactive websites using the syntax of R rather than needing to learn additional programming languages or software. Shiny apps can also be a nice way of enabling people to visualize data themselves instead of trying to provide them with an exhaustive pre-built set of all of the possible ways of visualizing those same data.
