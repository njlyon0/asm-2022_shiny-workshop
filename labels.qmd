...
:::callout-note
####
```{r label-ui-and-app-v4, message = F}
# Define the UI
label_ui <- fluidPage(
...
:::callout-note
####
```{r label-ui-and-app-v5, message = F}
# Define the UI
label_ui <- fluidPage(
...
:::callout-note
####
```{r label-ui-and-app-v6, message = F}
# Define the UI
label_ui <- fluidPage(
