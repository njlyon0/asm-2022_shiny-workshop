...
::: callout-note
####
```{r byo-overview-ui-v1, message = F}
...
::: callout-note
####
```{r byo-overview-app-v1, message = F}
...
::: callout-note
####
```{r byo-overview-app-v2, message = F}
shinyApp(ui = overview_ui, server = overview_server)
```
:::
...
::: callout-note
####
```{r byo-reactive-server-v1,  eval = FALSE}
...
::: callout-note
#### 
```{r byo-reactive-server-v2, message = F}
reactive_server <- function(input, output){
...
<img src="images/reactive-app-still.png" width="100%"/>
:::
